...
#iterate over not frankly list (mixed type ie: int, string, etc...
...
#good way of copying nested list, make copy and origin independent to eo
...
#or use copy module (import copy)
#import copy
